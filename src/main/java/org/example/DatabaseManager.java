...
public class DatabaseManager {
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/pv";
    private static final String USERNAME = "root";
    private static final String PASSWORD = "Pranav@0906";
    ...
    public static List teamWithMaxInterviews() {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            if (resultSet.next()) {
                ...
                String value=resultSet.getString("team");
                ls.add(value);
            }
